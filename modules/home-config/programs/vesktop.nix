...

{
    ...
    xdg.configFile."vesktop/settings/settings.json".text = ''
    {
        ...
        "plugins": {
            ...
            "GameActivityToggle": { "enabled": true, "location": "PANEL", "oldIcon": false },
            ...
            "Settings": { "enabled": true, "settingsLocation": "aboveNitro", "includeVencordInfoWhenCopying": true },
        ...
        "cloud": {
            ...
            "settingsSync": false,
            "settingsSyncVersion": 1778705148152
        }
    }
  '';
}
