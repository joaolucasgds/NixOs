{
    ...
    inputs = {
        ...
        wallpapers = {
            url = "https://github.com/joaolucasgds/Wallpapers/releases/download/WallpapersV2/Wallpapers.tar.gz";
            flake = false;
        };

        lanzaboote = { 
            url = "github:nix-community/lanzaboote/v1.1.0";#Don't forget to change this version from time to time
            inputs.nixpkgs.follows = "nixpkgs";
        };
